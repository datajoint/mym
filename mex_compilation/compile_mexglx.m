...
% mex -g -v -largeArrayDims -I. -I"/usr/include/mysql"  -L"/usr/lib/mysql" -L. -lmysqlclient libz.so.2  mym.cpp -v
mex -g -v -largeArrayDims -I. -I"/usr/include/mysql"  -L"/usr/lib/mysql" -L. -lmysqlclient -lz  mym.cpp -v
